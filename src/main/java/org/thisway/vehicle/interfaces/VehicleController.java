...
public class VehicleController {
    ...
    public SseEmitter getVehicleTracksStream(@AuthenticationPrincipal MemberDetails memberDetails) {
        return streamCoordinatesService.createStreamForCompany(memberDetails.getCompanyId(),
