...
- CHANGE-031은 현재 Vehicle 상태·좌표의 Power 이벤트 시각 정렬 단계이며 전체 334/334 통과다. Trip 중복/거리 모델,
  미래 시각·장치 인증, FE의 GPS 수신 시 자체 powerOn 추정은 남아 있다. [기록](work-logs/2026-09-06-vehicle-power-event-ordering.md).
